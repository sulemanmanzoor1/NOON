                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 ">
                            <div class="form-group">
                              ...
                              <input type="text" name="add_equipment" class="form-control" id="add_equipment" placeholder="Enter Equipment Name">
                            </div>
                          </div>
                          <div class="col-md-6 ">
                            <div class="form-group">
                          ...
                          <div class="col-md-6 ">
                            <div class="form-group">
                              ...
                              <input type="number" name="purchase" class="form-control " id="purchase" placeholder="Enter Purchase Price">
                            </div>
                          </div>
                          <div class="col-md-6 ">
                            <div class="form-group">

    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>All Monthly Salaries </h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">Monthly Report</li>
                <li class="breadcrumb-item"><a href="../forms/monthly.php">Add Monthly Salary</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <form id="frm" action="report/salary_monthly.php" method="POST">
                  <div class="row">
                    <div class="card-body">
                      <div class="col-12">
                        <div class="row">

        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                <!-- form start -->
                <form id="frm" action="Backend/Send/add_expense.php" method="POST">
                  <div class="row">
                    <div class="card-body">
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-6 ">
                            <div class="form-group">
                              ...
                              <input type="text" name="quantity" class="form-control" id="quantity" placeholder="Enter Product Name ">
                            </div>
                          </div>
                          <div class="col-md-6 ">
                            <div class="form-group">
                              <label for="exampleInputEmail1" class="">Price</label>
                              <input type="number" name="price" class="form-control " id="purchase" placeholder="Enter Price">
                            </div>
                          </div>
                          <!-- <div class="col-md-6 ">
                            <div class="form-group">
